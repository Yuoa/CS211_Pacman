...
void draw_image(void){
  ...
  /*for (j = 0; j < 16; j++) {
    for (i = 200*480*j; i < 200*480*(j+1); i+=4) {
      if (j & 8) *(phy_addr+i) = 0xFF;
      else *(phy_addr+i) = 0x00;
      if (j & 4) *(phy_addr+i+1) = 0xFF;
      else *(phy_addr+i+1) = 0x00;
      if (j & 2) *(phy_addr+i+2) = 0xFF;
      else *(phy_addr+i+2) = 0x00;
      if (j & 1) *(phy_addr+i+3) = 0xFF;
  ...
  for (j = 0; j < 16; j++) {
    for (i = 200*480*j; i < 200*480*(j+1); i+=4) {
      ...
      if (j & 2) *(phy_addr+i+1) = 0xFF;
      else *(phy_addr+i+1) = 0x00;
      if (j & 4) *(phy_addr+i+2) = 0xFF;
      else *(phy_addr+i+2) = 0x00;
      if (j & 8) *(phy_addr+i+3) = 0xFF;
      else *(phy_addr+i+3) = 0x00;
    }
  }
